...
`;
		...
		*/
		function resolveTheme() {
			...
			return {
				themeVars,
				colorScheme: scheme.includes("dark") && !scheme.includes("light") ? "dark" : scheme.includes("light") ? "light" : matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"
			};
		}
		//#endregion
		...
		*/
		...
		function Preview({ argsRaw }) {
			...
			(0, react.useEffect)(() => {
				if (!loaded || fragment === void 0) return;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: labelStyle,
					children: fragment === void 0 || fragment.length === 0 ? "Visualize · composing…" : "Visualize · streaming preview"
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("iframe", {
					ref: frameRef,
					sandbox: "allow-scripts",
					referrerPolicy: "no-referrer",
